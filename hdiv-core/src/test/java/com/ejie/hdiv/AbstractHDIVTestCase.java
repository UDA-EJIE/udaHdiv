...
public abstract class AbstractHDIVTestCase extends TestCase {
	...
	private String[] files = { 
			"/com/ejie/hdiv/config/hdiv-core-applicationContext.xml",
			"/com/ejie/hdiv/config/hdiv-config.xml",
			"/com/ejie/hdiv/config/hdiv-validations.xml",
			"/com/ejie/hdiv/config/applicationContext-extra.xml" };
