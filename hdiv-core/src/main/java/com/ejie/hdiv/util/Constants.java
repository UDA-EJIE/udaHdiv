...
public class Constants {
	 ...
	 */
	public static final String EDITABLE_PARAMETER_ERROR = "com.ejie.hdiv.action.EDITABLE_PARAMETER_ERROR";

	/**
	 * The request attributes key under HDIV should store data about errors produced in the editable fields.
	 */
	public static final String EDITABLE_PARAMETER_ERROR_DATA = "com.ejie.hdiv.action.EDITABLE_PARAMETER_ERROR_DATA";

	/**
	 * Name of the attribute which is used for storing cookies in session.
	 */
	public static final String HDIV_COOKIES_KEY = "com.ejie.hdiv.HdivCookies";
	 ...
	 * @since 2.1.5
	 */
	public static final String VALIDATOR_HELPER_RESULT_NAME = "com.ejie.hdiv.ValidatorHelperResult";
	 ...
	 */
	public static final String PAGE_ID_GENERATOR_NAME = "com.ejie.hdiv.PageIdGenerator";

	/**
	 * Session attribute name for {@link IStateCache} instance
	 */
	public static final String STATE_CACHE_NAME = "com.ejie.hdiv.StateCache";
	 ...
	 */
	public static final String MESSAGE_SOURCE_PATH = "com.ejie.hdiv.msg.MessageResources";
