...
public class DefaultSessionInitializer implements SessionInitializer, ApplicationContextAware {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ejie.hdiv.init.SessionInitializer#initializeSession(javax.servlet.http.HttpSession)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ejie.hdiv.init.SessionInitializer#destroySession(javax.servlet.http.HttpSession)
	 */
