 ...
 */
package com.ejie.hdiv.config.annotation.condition;
...
public class OnFrameworkCondition implements ConfigurationCondition {
	...
	protected final boolean grailsModulePresent = ClassUtils.isPresent("com.ejie.hdiv.web.servlet.support.GrailsHdivRequestDataValueProcessor",
			OnFrameworkCondition.class.getClassLoader());
	...
	protected final boolean thymeleafModulePresent = ClassUtils
			.isPresent("com.ejie.hdiv.web.servlet.support.ThymeleafHdivRequestDataValueProcessor", OnFrameworkCondition.class.getClassLoader());
