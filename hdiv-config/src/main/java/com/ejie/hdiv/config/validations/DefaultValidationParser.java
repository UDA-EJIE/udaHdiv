 ...
 */
package com.ejie.hdiv.config.validations;
...
public class DefaultValidationParser extends DefaultHandler {
	 ...
	 */
	private static final String DEFAULT_VALIDATION_PATH = "com/ejie/hdiv/config/validations/defaultEditableValidations.xml";
